...
<template>
    ...
    <div v-else class="contenedor">
        ...
        <div v-if="yaVotoSeleccion || isMenorEdad && seleccion !== 'Asamblea' && seleccion !== 'Representante SENA' " class="mt-12">
            ...
            <div class="flex justify-center mt-12">
                <RouterLink style="  background-color: #22c55e; width: 300px; height: 50px; text-align: center; padding: 14px; font-size: 1.5em;" to="inicio">
                    Volver
                </RouterLink>
            </div>
            ...
            <div v-if="token" class="contenedor">
                ...
                <div class="grid  grid-cols-3 max-[600px]:grid-cols-1   ">
                    ...
                    <div v-for="candidato in candidatos" @click="Seleccionar(candidato)" :key="candidato.div"
                        ...
                        <div 
                            class="seleccionadoBoton -ml-8 absolute ">
                        ...
                        <img 
                            :class="{ 'seleccionadoItems': candidato.id === candidatoSeleccionado.id && seleccionado }"
                    ...
                    <!-- Voto en blanco -->
                    <div
                        class="col-span-1  flex m-auto   items-centerjustify-center  "
                    >
                        <div 
                        
                            @click="SeleccionarBlanco" class="w-80 h-80 p-7 shadow-2xl m-16 text-center cursor-pointer"
                            :class="{ 'seleccionado seleccionadoItems': seleccionadoBlanco }">
                           
                            <h1 
                                :class="{ 'seleccionadoItems': seleccionadoBlanco }"
                            ...
                            <div class="seleccionadoBoton -ml-8  ">
                                ...
                                <FormKit v-if="seleccionadoBlanco"
                                    ...
                                    <p
                                    >Votar en <span class="font-bold"> BLANCO </span></p>
            ...
            <div v-else class="">
                ...
                <div class="mx-auto mt-10 rounded-md bg-white shadow  md:w-1/2 py-20 px-6">
                    <Login v-if="tieneCuenta" v-model:identificadorPersona="identificadorPersona" v-model:token="token"
                        v-model:tieneCuenta="tieneCuenta" 
                        v-model:isMenorEdad="isMenorEdad"
                        />
